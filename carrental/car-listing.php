        ...
        <div class="product-listing-m gray-bg">
          ...
          <div class="product-listing-content">
            ...
            <ul>
              ...
              <li><i class="material-icons" style="font-size:48px;color:red">import_contacts</i><?php echo htmlentities($result->FuelType);?></li>
            </ul>
...
<option value="Diesel">Diesel</option>
              ...
              <div class="form-group">
                <button type="submit" class="btn btn-block"><i class="fa fa-search" aria-hidden="true"></i>Search Cars</button>
              </div>
            </form>
          </div>
        </div>
