                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="predefined_styles">
                        <div class="skin-theme-switcher">
                            ...
                            <a href="#" data-switchcolor="blue" class="styleswitch" style="background-color:blue;"> </a>
                            <a href="#" data-switchcolor="pink" class="styleswitch" style="background-color:#00000;"> </a>
